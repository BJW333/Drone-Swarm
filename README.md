...
A modular Python framework for simulating autonomous drone swarms. Supports multi-layer obstacle avoidance, mesh network communications, leader election, mission planning, and real-time 3D visualization.
